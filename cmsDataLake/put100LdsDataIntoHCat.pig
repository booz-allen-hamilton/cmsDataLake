...
All variables and positioning were referenced from
inp_clm_saf_lds_100_2010.fts located on
the Data Lake 2010 disk.

comments reference the actual variable name in the fts file

the csv file being referenced is: inp_clm_saf_lds_100_2010.csv

*/
theFile = LOAD '$deno_file' using PigStorage(',');
lds100ldsInfo = FOREACH theFile GENERATE
...
store lds100ldsInfo into '$out_table' using org.apache.hcatalog.pig.HCatStorer();
