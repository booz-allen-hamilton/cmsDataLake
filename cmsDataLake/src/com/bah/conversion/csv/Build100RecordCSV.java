...
public class Build100RecordCSV {
...
//		List<String[]> rows = readAllRowsFromCSVFile(file);
		readAllRowsFromCSVFile(file);

//		titleHeader(rows);
		
//		File newcsvFile = new File("C:\\thunder\\workspace\\jsonDataLake\\hive_src\\JSON100LdsData.csv");
 ...
 */
	private static void readAllRowsFromCSVFile(File file) throws IOException {
		System.out.println("...... readAllRowsFromCSVFile ....."); 

		BufferedReader br = new BufferedReader(new FileReader("C:\\DataLakeGrp\\csv\\2010\\100pct\\sda\\win32\\DataLake.csv"));
		

		PrintWriter writer = new PrintWriter("C:\\thunder\\workspace\\jsonDataLake\\hive_src\\recordcatcher.csv","UTF-8");
...
//			System.out.println(lineWrite);
		...
		writer.close();
/*
		File adjCSVFile = new File("C:\\thunder\\workspace\\jsonDataLake\\hive_src\\recordcatcher.csv");
